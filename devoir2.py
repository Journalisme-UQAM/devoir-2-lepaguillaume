...
#Je fais intervenir les valeurs de mon dictionnaire dans la "loop" pour faire correspondre une valeur aux chiffres romains 
       ...
       ara = araS.split()
       a = ara[0]
#Je "strip" les éléments inutiles avant de les convertir en "integer"      
       a1 = re.sub("[^0-9]","", a)
       a2 = a1.strip()
#Je convertis en "integer" pour pourvoir additionner aux pages "leaves" les valeurs numériques que j'ai associées aux chiffres romains
